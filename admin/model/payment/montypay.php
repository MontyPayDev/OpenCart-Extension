<?php
namespace Opencart\Admin\Model\Extension\montypay\Payment;
class montypay extends \Opencart\System\Engine\Model{
    public function install(): void {
		$this->db->query("CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "montypay` (
	...
	public function uninstall(): void {
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "montypay`");
	}
